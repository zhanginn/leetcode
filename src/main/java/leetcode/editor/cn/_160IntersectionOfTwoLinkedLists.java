...
public class _160IntersectionOfTwoLinkedLists {
    public static void main(String[] args) {
        Solution solution = new _160IntersectionOfTwoLinkedLists().new Solution();
        System.out.println(solution.getIntersectionNode(new ListNode(4, new ListNode(1)), new ListNode(5, new ListNode(6, new ListNode(1)))));
    }
